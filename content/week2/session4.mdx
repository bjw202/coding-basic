...
stateDiagram-v2
    ...
    Mounting --> Idle: DOM Rendered, useEffect runs
    Idle --> Rendering: State or Props Changed
    Rendering --> Idle: DOM Updated, useEffect cleanup and re-run
...
- [JavaScript 완전 가이드](/appendix/language-guides/javascript-complete): React 이해에 필요한 JS 심화 개념(클로저, 프로토타입, 비동기)을 다룹니다
